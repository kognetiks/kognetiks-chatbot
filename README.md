...
4. **Add to Your Site**
   Use `[chatbot]` or `[chatbot style=floating]` to add AI chat anywhere.
...
|--|--|-|-|
| **OpenAI** | [Terms of Use](https://platform.openai.com/terms) | [Privacy Policy](https://openai.com/policies/privacy-policy/) | [API Key](https://platform.openai.com/account/api-keys)
| **Azure OpenAI** | [Terms of Use](https://learn.microsoft.com/en-us/legal/cognitive-services/openai/data-privacy?tabs=azure-portal) | [Privacy Policy](https://www.microsoft.com/en-us/privacy/privacystatement) | [API Key](https://azure.microsoft.com/en-us/pricing/purchase-options/azure-account?icid=ai-services)
| **NVIDIA** | [Terms of Use](https://www.nvidia.com/en-us/about-nvidia/nv-accounts/) | [Privacy Policy](https://www.nvidia.com/en-us/about-nvidia/privacy-policy/) | [API Key](https://developer.nvidia.com/nim)
