...
require_once plugin_dir_path(__FILE__) . 'widgets/chatbot-chatgpt-widget-endpoint.php';
require_once plugin_dir_path(__FILE__) . 'widgets/chatbot-chatgpt-widget-logging.php';
