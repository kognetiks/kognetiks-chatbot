...
defined ('CHATBOT_CHATGPT_VERSION') || define ('CHATBOT_CHATGPT_VERSION', '2.1.1');
...
function chatbot_chatgpt_send_message() {
    ...
    $chatbot_settings = array_merge($chatbot_settings, get_chatbot_chatgpt_threads($user_id, $page_id));
