...
function chatbot_chatgpt_call_mistral_api($api_key, $message, $user_id = null, $page_id = null, $session_id = null, $assistant_id = null, $client_message_id = null) {
    ...
    // back_trace("NOTICE", "Starting Mistral API call");
