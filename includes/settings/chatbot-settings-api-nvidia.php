...
function chatbot_nvidia_api_enabled_callback($args) {
    ...
    if ($model_choice == 'nvidia/llama-3.1-nemotron-70b-instruct' || $nvidia_api_enabled == 'Yes') {
        $nvidia_api_enabled = 'Yes';
...
function chatbot_nvidia_api_settings_init() {
    ...
    register_setting('chatbot_nvidia_api_model', 'chatbot_nvidia_api_enabled', 'sanitize_nvidia_api_enabled');
    register_setting('chatbot_nvidia_api_model', 'chatbot_nvidia_api_key', 'sanitize_nvidia_api_key');
