...
function chatbot_markov_chain_length_callback($args) {
    ...
    $markov_chain_length = esc_attr(get_option('chatbot_markov_chain_length', '2'));
...
function chatbot_markov_chain_next_phrase_length_callback($args) {
    ...
    $markov_chain_next_phrase_length = esc_attr(get_option('chatbot_markov_chain_next_phrase_length', '2'));
