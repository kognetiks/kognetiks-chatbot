...
function display_option_value_admin_notice() {
    ...
    if ($kn_results) {
        ...
        $dismiss_url = wp_nonce_url(
            ...
            chatbot_chatgpt_back_trace('Knowledge Navigator Outcome: ' . $kn_results);
    }
    ...
    //         chatbot_chatgpt_back_trace('API Status: ' . $api_status);
    // }
    ...
    if ($kn_status === 'Never Run') {
        $dismiss_url = wp_nonce_url(
            ...
            chatbot_chatgpt_back_trace('API Status: ' . $kn_status);
    }
