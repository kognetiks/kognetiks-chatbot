...
function chatbot_transformer_model_scheduler() {
    ...
    if (!isset($chatbot_transformer_model_build_schedule)) {
        $chatbot_transformer_model_build_schedule = 'Disable';
        update_option('chatbot_transformer_model_build_schedule', $chatbot_transformer_model_build_schedule);
    ...
    chatbot_transformer_model_scan();
