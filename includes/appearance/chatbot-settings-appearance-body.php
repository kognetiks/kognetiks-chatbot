...
function chatbot_chatgpt_appearance_background_custom_css_settings() {
    ...
    $GLOBALS['chatbotChatGPTAppearanceCSS']['chatbot-floating-style'] = ".chatbot-floating-style { background: {$chatbot_chatgpt_appearance_background_color} !important; }";
    $GLOBALS['chatbotChatGPTAppearanceCSS']['chatbot-embedded-style'] = ".chatbot-embedded-style { background: {$chatbot_chatgpt_appearance_background_color} !important; }";
